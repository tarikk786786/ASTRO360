...
import { 
  Globe2, Sparkles, Compass, Moon, Sun, Flame, Users, Heart, Zap, CheckCircle2, Shield, MessageCircle 
} from 'lucide-react';
...
export default function GlobalWisdomSuite({ userProfile }: GlobalWisdomSuiteProps) {
  const [activeTab, setActiveTab] = useState<'overview' | 'compatibility' | 'forecast' | 'customs'>('overview');
