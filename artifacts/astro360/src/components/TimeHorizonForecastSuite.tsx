...
export default function TimeHorizonForecastSuite({ userProfile }: TimeHorizonForecastSuiteProps) {
  ...
  return (
    <div className="p-6 rounded-3xl bg-[#111827] border border-cyan-500/40 shadow-2xl space-y-6 text-left relative overflow-hidden">
          ...
          {(['Today', 'Week', 'Month', 'Year'] as HorizonType[]).map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-2xl text-xs font-mono font-bold transition-all cursor-pointer flex items-center gap-1.5 ${
                selectedHorizon === tab
                  ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/50 shadow-lg scale-105'
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 p-4 rounded-2xl bg-[#0B1220] border border-white/10">
        <div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {current.keyDates.map((kd, idx) => (
            <span key={idx} className="text-[10px] font-mono text-slate-300 bg-white/5 px-2.5 py-1 rounded-xl border border-white/10">
              ⏱️ {kd}
            </span>
          ))}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-[#0B1220] border border-cyan-500/40 space-y-2 relative overflow-hidden shadow-lg group hover:border-cyan-400 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-cyan-400 uppercase tracking-wider flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-cyan-400" /> 1. Executive Forecast & Conclusion
            </span>
            <span className="text-[9px] font-mono text-cyan-300 bg-cyan-500/10 px-2 py-0.5 rounded border border-cyan-500/30">Primary Effect</span>
          </div>
          <p className="text-xs text-slate-200 leading-relaxed font-medium bg-cyan-950/20 p-3 rounded-xl border border-cyan-500/20">
            {current.conclusion}
          </p>
        ...
        <div className="p-5 rounded-2xl bg-[#0B1220] border border-amber-500/40 space-y-2 relative overflow-hidden shadow-lg group hover:border-amber-400 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1.5">
              <Compass className="w-4 h-4 text-amber-400" /> 2. Astronomical How & Why (Root Cause)
            </span>
            <span className="text-[9px] font-mono text-amber-300 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/30">Ephemeris Reason</span>
          </div>
          <p className="text-xs text-slate-200 leading-relaxed font-medium bg-amber-950/20 p-3 rounded-xl border border-amber-500/20">
            {current.howAndWhy}
          </p>

          <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-[10px] font-mono text-amber-300 space-y-1">
        ...
        <div className="p-5 rounded-2xl bg-[#0B1220] border border-emerald-500/40 space-y-2 relative overflow-hidden shadow-lg group hover:border-emerald-400 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-emerald-400" /> 3. Recommended Practical Solution
            </span>
            <span className="text-[9px] font-mono text-emerald-300 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/30">Action Step</span>
          </div>
          <p className="text-xs text-emerald-300 leading-relaxed font-semibold bg-emerald-950/30 p-3 rounded-xl border border-emerald-500/30">
            {current.solution}
          </p>
        ...
        <div className="p-5 rounded-2xl bg-[#0B1220] border border-purple-500/40 space-y-2.5 relative overflow-hidden shadow-lg group hover:border-purple-400 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-purple-400 uppercase tracking-wider flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-purple-400" /> 4. Sacred Remedies Across Traditions
            </span>
            <span className="text-[9px] font-mono text-purple-300 bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/30">Multi-Faith</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 font-mono text-[10px]">
            <div className="p-2.5 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-emerald-300 space-y-0.5">
            ...
            <div className="p-2.5 rounded-xl bg-amber-950/40 border border-amber-500/30 text-amber-300 space-y-0.5">
            ...
            <div className="p-2.5 rounded-xl bg-cyan-950/40 border border-cyan-500/30 text-cyan-300 space-y-0.5">
            ...
            <div className="p-2.5 rounded-xl bg-purple-950/40 border border-purple-500/30 text-purple-300 space-y-0.5">
