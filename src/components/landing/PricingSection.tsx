...
const PLANS = [
  {
    ...
    features: [
      'Precision Natal Chart & Ephemeris',
      'Daily transit horoscope & Moon phase',
      '12 Zodiac Sign deep traits & element breakdown',
      'Planetary Ephemeris & Golden Hours lookup',
  ...
  },
  {
    ...
    description: 'All Harmonic Charts, 120-Year Planetary Timelines, and complete PDF dossiers.',
    features: [
      'Full Harmonic & Divisional Charts (D1 to D60)',
      '120-Year Planetary Cycle timeline',
      'Multi-Tradition Relationship & Synastry compatibility',
      'Personalized Gemstone, Sound & Harmonic remedies',
  ...
  },
  {
    ...
    description: 'Conversational 24/7 Universal AI Astrological Oracle for deep queries on career, love, and life.',
    features: [
      '24/7 AI Astrological Oracle consultation',
      'Career, promotion & business timing guidance',
      'Relationship dynamics & karmic synastry',
      'Universal remedies & personalized astrological WHY',
