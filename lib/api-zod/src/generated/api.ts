 ...
 */
export const QueryAstrologyBody = zod.object({
  "prompt": zod.string(),
  "systemInstruction": zod.string().nullish(),
  "userProfile": zod.record(zod.string(), zod.unknown()).nullish()
})

export const QueryAstrologyResponse = zod.object({
  "text": zod.string()
})
